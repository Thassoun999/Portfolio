      ...
      <div className="flex flex-col sm:flex-row-reverse justify-between sm:gap-5 items-start mb-15">
        ...
        <div className="w-full sm:w-3/5 sm:pl-10 text-white sm:mt-2 ">
          ...
          <p className="text-2xl 2xl:text-3xl pl-4 w-full space-y-2 sm:space-y-4">
            Sydra (Tae) Hassoun is a Trans Lebanese-American Multidisciplinary
            Artist and Creative Programmer based in NYC. She has always strived
            to make interactive canvases that place heavy emphasis on play and
            wonder. This can be found through her games, her multi-dimesional
            art, and even her website work. Backwards Sunrise is both a
            continuation of this practice and a call to radical action. Her
            current direction is to the roots of her people, the empowerment of
            her community, and creative liberation. The goal on the horizon is a
            transformation of the interconnected web, one that can foster
